...
#SBATCH --output=/mmfs1/gscratch/ark/hari/rhythmic_trascription/out/blml_pretrain_%j.out
        ...
        for embed_size in "${embed_sizes[@]}"; do
            for hidden_size in "${hidden_sizes[@]}"; do
                ...
                python pretrain.py \
                    ...
                    --output_dir "output/presentation_results/models/barlines_and_measure_lengths/lr_$lr/b_size_$batch_size/emb_$embed_size/hid_$hidden_size" \
