...
if __name__ == "__main__":
    ...
    base_input_path = "output/presentation_results/decode"
    # base_output_path = "output/presentation_results/ablations/perfect_decode/added_barlines"
    base_output_path = "output/presentation_results/added_barlines_with_measure_lengths"
    ...
    for i, row in tqdm(data.iterrows()):
        ...
        for base_value in ["0.25", "0.5", "1", "2", "3", "4"]:
            ...
            input_path = os.path.join(base_input_path, piece, f"base_value_{base_value}", "output.json")
            output_path = os.path.join(base_output_path, piece, f"base_value_{base_value}", "output.json")
