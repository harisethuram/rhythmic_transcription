...
if __name__ == "__main__":
    ...
    parser.add_argument("--channel_path", type=str, required=False, help="Path to the channel model")
    parser.add_argument("--processed_data_dir", type=str, required=True, help="Path to the processed data directory")
    parser.add_argument("--note_info_path", type=str, required=True, help="Path to the note info file")
    ...
    decoder = Decoder(language_model, channel_model, args.processed_data_dir, args.beam_width, args.temperature)
